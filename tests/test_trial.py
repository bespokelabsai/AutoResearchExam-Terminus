...
from harbor_autoresearch.results import GraderRecord
from harbor_autoresearch.trial import (
    AgentPhaseOutcome,
    AgentPhaseStatus,
    TimedWindowTrial,
    _RunState,
...
async def test_trial_selects_private_score_by_earliest_best_intermediate_and_hides_it(
    ...
    assert summary["configuration"]["task_name"] == "bespokelabs/example-task"
